...
class CreateProjectRowasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_rowas', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique('project_id','project_rowa_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_rowas');
    }
}

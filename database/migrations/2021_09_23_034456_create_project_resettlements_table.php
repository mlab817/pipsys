...
class CreateProjectResettlementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_resettlements', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('project_resettlements');
    }
}

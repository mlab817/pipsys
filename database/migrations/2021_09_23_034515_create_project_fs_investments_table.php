...
class CreateProjectFsInvestmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_fs_investments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('project_id')->constrained();
            $table->foreignId('ref_fund_source_id')->constrained();
            ...
            $table->unique(['project_id','ref_fund_source_id'], 'project_fs_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_fs_investments');
    }
}

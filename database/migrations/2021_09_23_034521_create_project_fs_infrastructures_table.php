...
class CreateProjectFsInfrastructuresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_fs_infrastructures', function (Blueprint $table) {
            $table->id();
            $table->foreignId('project_id')->constrained()->cascadeOnDelete();
            $table->foreignId('ref_fund_source_id')->constrained()->cascadeOnDelete();
            ...
            $table->unique(['project_id','ref_fund_source_id'], 'project_fsi_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_fs_infrastructures');
    }
}

...
class CreateProjectRegionInvestmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_region_investments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('project_id')->constrained();
            $table->foreignId('ref_region_id')->constrained();
            ...
            $table->unique(['project_id','ref_region_id'], 'project_region_inv_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_region_investments');
    }
}

...
class CreateProjectRegionInfrastructuresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_region_infrastructures', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('project_region_infrastructures');
    }
}

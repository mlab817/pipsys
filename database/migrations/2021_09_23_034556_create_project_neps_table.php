...
class CreateProjectNepsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_neps', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique('project_id','project_nep_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_neps');
    }
}

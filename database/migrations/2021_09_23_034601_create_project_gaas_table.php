...
class CreateProjectGaasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_gaas', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique('project_id','project_gaa_id');
        });
    }
    ...
    {
        Schema::dropIfExists('project_gaas');
    }
}

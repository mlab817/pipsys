<div class="mt-2" x-data="{
    ...
    <div class="tabnav mb-0">
        <div class="tabnav-extra float-right">
            <markdown-toolbar for="{{ $fieldName }}">
                ...
                <md-header class="mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M3.75 2a.75.75 0 01.75.75V7h7V2.75a.75.75 0 011.5 0v10.5a.75.75 0 01-1.5 0V8.5h-7v4.75a.75.75 0 01-1.5 0V2.75A.75.75 0 013.75 2z"></path></svg>
                </md-header>
                <md-italic class="mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M6 2.75A.75.75 0 016.75 2h6.5a.75.75 0 010 1.5h-2.505l-3.858 9H9.25a.75.75 0 010 1.5h-6.5a.75.75 0 010-1.5h2.505l3.858-9H6.75A.75.75 0 016 2.75z"></path></svg>
                </md-italic>
                <md-quote class="mr-1">
        ...
        <nav class="tabnav-tabs ml-2" aria-label="Switch active tab">
            ...
            <a class="tabnav-tab cursor-pointer" :aria-current="tab === 'preview' ? 'page' : null" @click="tab = 'preview'">Preview</a>
        </nav>
    </div>
    <div class="Box border p-2 border-top-0 rounded-top-0">
        <textarea x-show="tab === 'write'" name="{{ $fieldName }}" id="{{ $fieldName }}" class="form-control" style="resize: none;" x-model="value"></textarea>
        <div x-cloak x-show="tab === 'preview'" x-html="formatted" style="height: 200px; overflow: auto;"></div>
        <a class="tabnav-extra p-0 m-0" target="_blank" href="javascript:void(0)">
            <svg class="octicon octicon-markdown v-align-bottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg>

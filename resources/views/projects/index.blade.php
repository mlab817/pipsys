                ...
                <div class="col-2 col-lg-3 d-flex flex-column flex-justify-around">
                    <div class="text-right">
                        <div class="d-inline-block js-social-container js-form-toggle-container">
                            <form class="js-social-form js-form-toggle-target" hidden="hidden" action="{{ route('projects.update', $project) }}" accept-charset="UTF-8" method="post">
                                @csrf
                            ...
                            <form class="js-social-form js-form-toggle-target" action="{{ route('projects.update', $project) }}" accept-charset="UTF-8" method="post">
                                @csrf
